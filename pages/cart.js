...
export default function Cart() {
  ...
  const updateQuantity = (id, amount) => {
    console.log('Modification de la quantité pour l\'article:', id, 'ajout de:', amount);
    ...
    return (
      <>
        <Head>
          ...
          <meta name="description" content="Votre panier d'achats chez MonSavonVert - Savons artisanaux écologiques" />
              ...
              {cartItems.length > 0 ? (
                <div className={styles.cartContent}>
                  ...
                  <div className={styles.cartSummary}>
                    ...
                    <button className={`${styles.button} ${styles.primaryButton} ${styles.checkoutButton}`}>
                      Passer à la caisse
                    </button>
                    <Link href="/store" legacyBehavior>
