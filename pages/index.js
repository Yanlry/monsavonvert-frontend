...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const totalItems = Array.isArray(storedCart) ? storedCart.reduce((sum, item) => sum + (item.quantity || 0), 0) : 0;
                  ...
                  <div className={styles.heroContent}>
                    <h1 className={styles.heroTitle}>
                      {slide.title.split(' ').map((word, i) => (
                        <span key={i} className={styles.heroWord} style={{animationDelay: `${i * 0.1}s`}}>
                          {word}{' '}
                        </span>
                      ))}
                    </h1>
  ...
  <div className={styles.categoriesContainer}>
    <div className={styles.categoriesHeaderContainer}>
      ...
      <div className={styles.headerDecorLine}></div>
        ...
        <h2 className={styles.categoriesHeading}>
          Trouvez votre <span className={styles.categoryHighlight}>savon parfait</span>
        </h2>
      ...
      <div className={styles.categoryCardsRow}>
        {productCategories.map((category, index) => (
          <Link
            key={category.id}
            href={category.link}
            className={`${styles.categoryCardNew} ${styles[`categoryColor${index + 1}`]}`}
          >
            ...
            <div className={styles.categoryMediaStack}>
              <div className={styles.categoryImageFrame}>
                <div className={styles.categoryImageWrapper} style={{backgroundImage: `url(${category.image})`}}>
                  <div className={styles.categoryImageFilter}></div>
                </div>
              </div>
              <div className={styles.categoryBadge}>
                <div className={styles.badgeContent}>
                  <span className={styles.badgeValue}>{category.percentage}</span>
                  <span className={styles.badgeType}>Huile de<br/>baie de laurier</span>
                </div>
              </div>
              <div className={styles.categoryIconCircle}>
                <div className={styles.categoryIconWrapper}>
                  <span className={styles.categoryIconSymbol}>{category.icon}</span>
                </div>
              </div>
            </div>
            ...
            <div className={styles.categoryDetailsContainer}>
              ...
              <div className={styles.categoryFooter}>
                <div className={styles.categorySpecifics}>
                  <span className={styles.categorySpecTitle}>Idéal pour:</span>
                  <span className={styles.categorySpecValue}>{category.suitableFor}</span>
                </div>
                
                <div className={styles.categoryAction}>
                  <span className={styles.categoryActionText}>Découvrir</span>
    ...
    <div className={styles.categoryExploreMore}>
      <Link href="/boutique" className={styles.exploreButton}>
        <span className={styles.exploreText}>Voir toutes nos gammes</span>
    ...
    <div className={styles.shippingCard}>
      ...
      <div className={styles.shippingInfo}>
        <div className={styles.shippingTitleGroup}>
          <h3 className={styles.shippingTitleNew}>Livraison gratuite</h3>
          <div className={styles.shippingBadge}>Économisez</div>
        </div>
        <p className={styles.shippingDescription}>
          Pour toute commande à partir de <span className={styles.shippingHighlight}>29€</span>
        </p>
      </div>
    ...
    <div className={styles.aboutHeaderWrap}>
      <div className={styles.aboutHeader}>
        ...
        <h2 className={styles.aboutHeading}>
          Des savons <span className={styles.headingEmphasis}>100% artisanaux</span>
        </h2>
        <p className={styles.aboutSubheading}>
          Une passion pour les produits naturels et un engagement envers la durabilité environnementale.
        </p>
      </div>
    </div>
  ...
  <div className={styles.featuresContainer}>
    <div className={styles.featuresHeaderWrap}>
      <div className={styles.featuresHeader}>
        ...
        <h2 className={styles.featuresHeading}>
          Pourquoi choisir <span className={styles.headingEmphasis}>MonSavonVert</span> ?
        </h2>
    ...
    <div className={styles.featuresMainContent}>
      ...
      <div className={styles.featuresCardGrid}>
        {brandFeatures.map((feature, index) => (
          <div 
            key={feature.id} 
            className={`${styles.featureCardNew} ${styles[`featureCard${index + 1}`]}`}
          ...
          >
            ...
            <div className={styles.featureCardContent}>
              ...
              <div className={styles.featureTextContent}>
                <h3 className={styles.featureCardHeading}>{feature.title}</h3>
    ...
    <div className={styles.featuresExtraBanner}>
      <div className={styles.bannerContent}>
        ...
        <h3 className={styles.bannerTitle}>Des savons qui respectent votre peau et la planète</h3>
        <p className={styles.bannerText}>
          Nos formules exclusives sont le fruit de recherches approfondies et d'un savoir-faire traditionnel.
        </p>
      </div>
  ...
  <div className={styles.environmentContainer}>
    ...
    <div className={styles.headerDecorLine}></div>
      ...
      <h2 className={styles.environmentTitle}>
        Un impact positif <span className={styles.titleHighlight}>pour la planète</span>
      </h2>
      ...
      <div className={styles.environmentImagePanel}>
        <div className={styles.environmentMediaWrapper}>
          <div className={styles.environmentImageContainer}>
            <img src="/images/6.JPEG" alt="Engagement environnemental" className={styles.environmentImage} />
          ...
          <div className={styles.environmentBadge}>
            <div className={styles.environmentBadgeInner}>
              ...
              <span className={styles.badgeText}>ECO<br />FRIENDLY</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.environmentContentPanel}>
          ...
          {[
            {
              icon: "♻️",
              title: "Zéro Déchet",
              description: "Nos emballages sont biodégradables ou recyclables, et nous utilisons du papier ensemencé qui peut être planté après utilisation.",
              color: "green"
            },
            {
              icon: "🌱",
              title: "Circuit Court",
              description: "Nous privilégions les fournisseurs locaux pour réduire l'empreinte carbone et soutenir l'économie locale.",
              color: "teal"
            },
            {
              icon: "⚡",
              title: "Énergie Verte",
              description: "Notre atelier fonctionne à l'énergie verte et nous optimisons notre consommation d'eau dans tous nos processus.",
              color: "blue"
            },
            {
              icon: "🐰",
              title: "Vegan et sans cruauté",
              description: "Nos savons sont formulés sans aucun ingrédient d'origine animale et ne sont jamais testés sur les animaux.",
              color: "purple"
            }
          ].map((item, index) => (
            <div key={index} className={`${styles.environmentCard} ${styles[`environmentCard${item.color}`]}`}>
              <div className={styles.environmentCardContent}>
                <div className={styles.environmentCardIconWrap}>
                  <div className={styles.environmentCardIcon}>{item.icon}</div>
                </div>
                <h3 className={styles.environmentCardTitle}>{item.title}</h3>
                <p className={styles.environmentCardText}>{item.description}</p>
              </div>
        ...
        <div className={styles.environmentAction}>
          <Link href="/virtues" className={styles.environmentButton}>
            <span className={styles.buttonText}>Découvrir nos actions</span>
    ...
    <div className={styles.environmentStats}>
      <div className={styles.environmentStatItem}>
        ...
        <div className={styles.environmentStatLabel}>Moins d'emballage</div>
      </div>
      <div className={styles.environmentStatItem}>
        <div className={styles.environmentStatValue}>100%</div>
        <div className={styles.environmentStatLabel}>Biodégradable</div>
      </div>
      <div className={styles.environmentStatItem}>
  ...
  <div className={styles.testimonialsContainer}>
    ...
    <div className={styles.headerDecorLine}></div>
      ...
      <div className={styles.ratingBox}>
        ...
        <div className={styles.ratingScore}>4.9/5 basé sur 256 avis vérifiés</div>
      </div>
    </div>
      ...
      <div className={styles.testimonialCard}>
        ...
        <div className={styles.testimonialContent}>
          ...
          <p className={styles.testimonialText}>
            J'ai découvert ces savons il y a 6 mois et ma peau s'est transformée. 
            Plus de problèmes de sécheresse et l'odeur est divine ! Je recommande 
            particulièrement le savon à l'avoine pour les peaux sensibles.
          </p>
        </div>
      </div>
      ...
      <div className={styles.testimonialCard}>
        ...
        <div className={styles.testimonialContent}>
          ...
          <p className={styles.testimonialText}>
            ...
            jamais. Le service client est également excellent, très réactif.
          </p>
        </div>
      </div>
        ...
        <div className={styles.testimonialTop}>
          <div className={styles.testimonialUser}>
            ...
            <div className={styles.testimonialInfo}>
              ...
              <p className={styles.testimonialLocation}>Marseille, France</p>
            </div>
          </div>
          <div className={styles.testimonialBadge}>✓</div>
        </div>
              ...
              <div className={styles.newsletterContent}>
                ...
                <form className={styles.newsletterForm}>
                  ...
                  <label className={styles.consentLabel}>
                    <input type="checkbox" required className={styles.consentCheckbox} />
                ...
                <div className={styles.footerColumn}>
                  ...
                  <div className={styles.contactInfo}>
                    <div className={styles.contactItem}>
                      ...
                      <a href="tel:+33612345678" className={styles.contactLink}>+33 6 12 34 56 78</a>
                    </div>
                    ...
                    <div className={styles.contactItem}>
                      ...
                      <a href="mailto:info@monsavonvert.fr" className={styles.contactLink}>info@monsavonvert.fr</a>
                    </div>
