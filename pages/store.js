        ...
        <main className={styles.mainContent}>
          ...
          <div className={styles.storeHero}>
            <div className={styles.storeHeroContent}>
              ...
              <p className={styles.storeSubtitle}>
                Découvrez notre gamme de savons artisanaux élaborés avec des
                ingrédients biologiques, conçus pour prendre soin de votre peau
                et de la planète.
              </p>
            </div>
          </div>
                          ...
                          <div className={styles.usageTipsContainer}>
                            <div className={styles.usageTipsHeader}>
                              <svg
                                ...
                                strokeLinecap="round"
                                strokeLinejoin="round"
                                className={styles.usageTipsIcon}
                              >
                          ...
                          <div className={styles.notRecommendedContainer}>
                            <div className={styles.notRecommendedHeader}>
                              <svg
                                ...
                                strokeLinecap="round"
                                strokeLinejoin="round"
                                className={styles.notRecommendedIcon}
                              >
          ...
          <div className={styles.enhancedPromoSection}>
            <div className={styles.promoContent}>
              ...
              <a href="/boutique" className={styles.promoButton}>
