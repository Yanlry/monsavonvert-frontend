...
export default function AdminProducts() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch("https://monsavonvert-frontend.vercel.app/products");
        if (!response.ok) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://monsavonvert-frontend.vercel.app/products/add", {
        method: "POST",
        body: productData,
      });
    ...
    const performDelete = async () => {
      try {
        ...
        const response = await fetch(
          `https://monsavonvert-frontend.vercel.app/products/delete/${selectedProduct._id}`,
          {
            method: "DELETE",
          }
        );
  ...
  const handleUpdateProduct = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://monsavonvert-frontend.vercel.app/products/update/${selectedProduct._id}`,
        {
          method: "PUT",
          body: productData,
        }
